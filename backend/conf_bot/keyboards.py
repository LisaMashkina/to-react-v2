...
where_reg = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text='Вернуться на сайт', link='', callback_data='site'), #TODO добавить ссылку
                                                   InlineKeyboardButton(text='Продолжить здесь', callback_data='start_reg')]])
